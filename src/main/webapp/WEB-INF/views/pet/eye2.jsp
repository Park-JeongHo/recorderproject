	...
	$(document).ready(function(){
		$("button").on("click", function(e){
			...
			if(oper == "home"){
				...
				frm.attr("action", "${cpath}/dtl.do");  // 플라스크 연동후 수정해야 함 
				frm.attr("method", "get");
...
font-family: 'KyoboHand';">안구질환</button>
			...
			<div class="dropdown" style="float: right; margin-top: 35px;">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="#">검사기록실</a>
					<a class="dropdown-item" href="${cpath}/logout.do">로그아웃</a>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row mb-5 align-items-center">
				...
				<div class="col-md-6">
					<h2 class="font-weight-bold heading text-primary mb-4 mb-md-0">현재 ${m.user_name}님의 아이는 ${DtlList.dtl_title}일 확률이 높아요</h2>
			...
			<div>
			<br>
				<button data-oper = "home" type = "button" class = "btn btn-primary btn-sm">돌아가기</button>
				<button data-oper = "eye" type = "button" class = "btn btn-primary btn-sm">질병 상세정보</button>
				<button data-oper = "hospital" type = "button" class = "btn btn-primary btn-sm">병원찾기</button>
			</div>
			<form id = "frm">
				<input type = "hidden">
			</form>
