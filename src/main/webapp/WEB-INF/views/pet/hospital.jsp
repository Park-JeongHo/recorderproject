	...
	<div class="container">
		...
		<div class="container">
			...
			<div class="row mb-5 align-items-center">
				...
				<div class="col-md-6">
					<h2 class="font-weight-bold heading text-primary mb-4 mb-md-0">가까운 동물병원을 찾아볼게요</h2>
				</div>
				        ...
				        <div class="option">
				            <div>
				                <form onsubmit="searchPlaces(); return false;">
				                    현재위치를 입력해주세요 : <input type="text" value="동물병원" id="keyword" size="15"> 
			...
			<div>
			<br>
				<button type = "button" class = "btn btn-primary btn-sm" onclick="location.href = '${cpath}/home.do'">돌아가기</button>
			</div>
		</div>
	</div>
		</div>
