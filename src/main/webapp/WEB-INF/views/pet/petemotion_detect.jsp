   ...
   <body>
      <h1>애완동물 감정예측 판별 인공지능</h1>
         ...
         <p>
            ...
            <div id='spinner' class="spinner-border text-primary" style="visibility:collapse"></div>
         </p>
      <hr>
      <h2>업로드 이미지</h2>
      <video id="upload_image" style="max-width:500px;max-height:500px;" controls>
      </video>
      <hr>
      <h2>판별 결과</h2>
      <div id="result" />
